...
pub fn build(items: &[ItemClass]) -> String {
    ...
    let output = quote! {
        ...
        use crate::behavior::items::{BlockItemBehavior, EnderEyeBehavior, HangingSignItemBehavior, SignItemBehavior, StandingAndWallBlockItem, ShovelBehavior, FilledBucketBehavior, EmptyBucketBehavior, HoeBehavior};
