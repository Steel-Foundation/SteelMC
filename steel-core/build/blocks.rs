...
pub fn build(blocks: &[BlockClass]) -> String {
    ...
    let mut nether_sprouts_blocks = Vec::new();
    ...
    let mut tall_flower_blocks = Vec::new();
    ...
    for block in blocks {
        ...
        match block.class.as_str() {
            ...
            "NetherSproutsBlock" => nether_sprouts_blocks.push(const_ident),
            ...
            "TallFlowerBlock" => tall_flower_blocks.push(const_ident),
    ...
    let nether_sprouts_type = Ident::new("NetherSproutsBlock", Span::call_site());
    ...
    let tall_flower_type = Ident::new("TallFlowerBlock", Span::call_site());
    ...
    let nether_sprouts_registrations =
        generate_registrations(nether_sprouts_blocks.iter(), &nether_sprouts_type);
    ...
    let tall_flower_registrations =
        generate_registrations(tall_flower_blocks.iter(), &tall_flower_type);
