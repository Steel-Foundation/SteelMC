...
///
/// Chest are container block entities with 27 slots (3x9 grid).
...
impl BlockBehavior for ChestBlock {
    fn get_state_for_placement(&self, context: &BlockPlaceContext<'_>) -> Option<BlockStateId> {
        // Chest faces opposite to the player's look direction (all 6 directions).
    ...
    fn use_without_item(
        ...
        // Open the chest menu (3 rows for chest)
        ...
        //       for recheck functionality. See vanilla ChestBlockEntity and ContainerOpenersCounter.
