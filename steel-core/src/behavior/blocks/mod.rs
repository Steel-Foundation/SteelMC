...
pub use building::{
    ...
    IronBarsBlock, LavaCauldronBlock, MagmaBlock, PowderSnowBlock, RotatedPillarBlock,
    ScaffoldingBlock, SlabBlock, SlimeBlock, StairBlock, WallBlock, WeatherState, WeatheringCopper,
