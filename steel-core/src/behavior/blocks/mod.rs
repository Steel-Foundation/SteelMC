...
pub use vegetation::{
    ...
    FlowerBlock, MangroveLeavesBlock, MultifaceBlock, NetherSproutsBlock, NetherWartBlock,
    PitcherCropBlock, PotatoBlock, PumpkinBlock, RootedDirtBlock, SeagrassBlock, SugarCaneBlock,
