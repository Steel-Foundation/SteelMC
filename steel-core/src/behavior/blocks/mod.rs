...
pub use building::{
    ...
    FenceBlock, FenceGateBlock, HayBlock, HoneyBlock, IronBarsBlock, LadderBlock,
    LavaCauldronBlock, MagmaBlock, PotentSulfurBlock, PowderSnowBlock, RespawnAnchorBlock,
