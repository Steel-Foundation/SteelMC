...
pub use vegetation::{
    ...
    NetherFungusBlock, NetherRootsBlock, NetherSproutsBlock, PointedDripstoneBlock, SculkVeinBlock,
    SeaPickleBlock, SeagrassBlock, ShortDryGrassBlock, SmallDripleafBlock, SnowLayerBlock,
    SporeBlossomBlock, SugarCaneBlock, SweetBerryBushBlock, TallDryGrassBlock, TallFlowerBlock,
    TallGrassBlock, TallSeagrassBlock, TwistingVinesBlock, TwistingVinesPlantBlock, VineBlock,
