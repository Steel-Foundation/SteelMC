...
use super::{
    ...
    EntityVerticalMovementStateUpdate, HURT_DURATION_TICKS, InsideBlockEffectCollector,
    InsideBlockEffectType, LivingEntity, LivingEntityBase, LivingTravelInput, MobEffectInstance,
