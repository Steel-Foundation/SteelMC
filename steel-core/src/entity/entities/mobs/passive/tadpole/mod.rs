//! Vanilla Tadpole entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the tadpole.
...
impl Entity for TadpoleEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_TADPOLE_FLOP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for TadpoleEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TADPOLE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TADPOLE_DEATH)
    }
...
impl Mob for TadpoleEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TADPOLE_FLOP)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
