//! Vanilla Axolotl entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the axolotl.
...
impl Entity for AxolotlEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_AXOLOTL_IDLE_WATER,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for AxolotlEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_AXOLOTL_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_AXOLOTL_DEATH)
    }
...
impl Mob for AxolotlEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_AXOLOTL_IDLE_AIR)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
