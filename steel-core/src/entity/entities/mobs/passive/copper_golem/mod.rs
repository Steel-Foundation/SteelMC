//! Vanilla CopperGolem entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the copper golem.
...
impl Entity for CopperGolemEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_COPPER_GOLEM_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for CopperGolemEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_COPPER_GOLEM_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_COPPER_GOLEM_DEATH)
    }
...
impl Mob for CopperGolemEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_COPPER_GOLEM_SPAWN)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
