//! Vanilla Parrot entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the parrot.
...
impl Entity for ParrotEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_PARROT_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for ParrotEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PARROT_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PARROT_DEATH)
    }
...
impl Mob for ParrotEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PARROT_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
