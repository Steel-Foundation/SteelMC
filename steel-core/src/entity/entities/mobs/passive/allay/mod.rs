//! Vanilla Allay entity — ported from Pumpkin (foundation-first).
...
impl Entity for AllayEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_ALLAY_AMBIENT_WITHOUT_ITEM,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for AllayEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ALLAY_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ALLAY_DEATH)
    }
...
impl Mob for AllayEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ALLAY_AMBIENT_WITHOUT_ITEM)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
