//! Vanilla Squid entity — ported from Pumpkin (foundation-first).
...
impl Entity for SquidEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_SQUID_SQUIRT,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for SquidEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SQUID_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SQUID_DEATH)
    }
...
impl Mob for SquidEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SQUID_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
