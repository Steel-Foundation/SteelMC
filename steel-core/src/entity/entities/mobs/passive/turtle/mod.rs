//! Vanilla Turtle entity — ported from Pumpkin (foundation-first).
...
impl Entity for TurtleEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_TURTLE_SHAMBLE,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for TurtleEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TURTLE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TURTLE_DEATH)
    }
...
impl Mob for TurtleEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TURTLE_AMBIENT_LAND)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
