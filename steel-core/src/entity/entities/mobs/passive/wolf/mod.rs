//! Vanilla Wolf entity — ported from Pumpkin (foundation-first).
...
impl Entity for WolfEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_WOLF_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for WolfEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WOLF_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WOLF_DEATH)
    }
...
impl Mob for WolfEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WOLF_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
