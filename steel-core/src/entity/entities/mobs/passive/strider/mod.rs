//! Vanilla Strider entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the strider.
...
impl Entity for StriderEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_STRIDER_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for StriderEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_STRIDER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_STRIDER_DEATH)
    }
...
impl Mob for StriderEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_STRIDER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
