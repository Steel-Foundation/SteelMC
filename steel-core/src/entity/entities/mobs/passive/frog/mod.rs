//! Vanilla Frog entity — ported from Pumpkin (foundation-first).
...
impl Entity for FrogEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_FROG_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for FrogEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_FROG_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_FROG_DEATH)
    }
...
impl Mob for FrogEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_FROG_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
