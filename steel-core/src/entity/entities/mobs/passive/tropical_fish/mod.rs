//! Vanilla TropicalFish entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the tropical fish.
...
impl Entity for TropicalFishEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_TROPICAL_FISH_FLOP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for TropicalFishEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TROPICAL_FISH_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TROPICAL_FISH_DEATH)
    }
...
impl Mob for TropicalFishEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_TROPICAL_FISH_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
