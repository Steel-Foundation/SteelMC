//! Vanilla Goat entity — ported from Pumpkin (foundation-first).
...
impl Entity for GoatEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_GOAT_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for GoatEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GOAT_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GOAT_DEATH)
    }
...
impl Mob for GoatEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GOAT_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
