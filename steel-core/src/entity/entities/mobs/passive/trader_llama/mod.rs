//! Vanilla TraderLlama entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the trader llama.
...
impl Entity for TraderLlamaEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_LLAMA_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for TraderLlamaEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_LLAMA_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_LLAMA_DEATH)
    }
...
impl Mob for TraderLlamaEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_LLAMA_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
