//! Vanilla Sniffer entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the sniffer.
...
impl Entity for SnifferEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_SNIFFER_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for SnifferEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SNIFFER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SNIFFER_DEATH)
    }
...
impl Mob for SnifferEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SNIFFER_IDLE)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
