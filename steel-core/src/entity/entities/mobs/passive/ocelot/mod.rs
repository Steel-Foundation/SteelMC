//! Vanilla Ocelot entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the ocelot.
...
impl Entity for OcelotEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_CAT_AMBIENT, 0.15, 1.0);
    }
...
impl LivingEntity for OcelotEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_OCELOT_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_OCELOT_DEATH)
    }
...
impl Mob for OcelotEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_OCELOT_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
