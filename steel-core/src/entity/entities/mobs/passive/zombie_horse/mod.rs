//! Vanilla ZombieHorse entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the zombie horse.
...
impl LivingEntity for ZombieHorseEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIE_HORSE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIE_HORSE_DEATH)
    }
...
impl Mob for ZombieHorseEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIE_HORSE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
