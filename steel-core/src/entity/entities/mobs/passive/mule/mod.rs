//! Vanilla Mule entity — ported from Pumpkin (foundation-first).
...
impl LivingEntity for MuleEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_MULE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_MULE_DEATH)
    }
...
impl Mob for MuleEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_MULE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
