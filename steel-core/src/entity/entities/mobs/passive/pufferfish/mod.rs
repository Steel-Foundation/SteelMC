//! Vanilla Pufferfish entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the pufferfish.
...
impl PufferfishEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        fish_init_mob_base(&mob_base);
        {
            ...
            // TODO: Add PufferfishPuffGoal when pufferfish AI is implemented
        }
        Self {
            base,
            entity_type,
...
impl Entity for PufferfishEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_PUFFER_FISH_FLOP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for PufferfishEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PUFFER_FISH_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PUFFER_FISH_DEATH)
    }
...
impl Mob for PufferfishEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PUFFER_FISH_BLOW_OUT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
