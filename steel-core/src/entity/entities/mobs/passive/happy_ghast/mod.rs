//! Vanilla HappyGhast entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the happy ghast.
...
impl Entity for HappyGhastEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_HAPPY_GHAST_AMBIENT,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for HappyGhastEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HAPPY_GHAST_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HAPPY_GHAST_DEATH)
    }
...
impl Mob for HappyGhastEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HAPPY_GHAST_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
