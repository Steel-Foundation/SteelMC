//! Vanilla SkeletonHorse entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the skeleton horse.
...
impl Entity for SkeletonHorseEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_HORSE_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for SkeletonHorseEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SKELETON_HORSE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SKELETON_HORSE_DEATH)
    }
...
impl Mob for SkeletonHorseEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SKELETON_HORSE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
