//! Vanilla Bee entity — ported from Pumpkin (foundation-first).
...
impl Entity for BeeEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_BEE_LOOP, 0.15, 1.0);
    }
...
impl LivingEntity for BeeEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BEE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BEE_DEATH)
    }
...
impl Mob for BeeEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BEE_LOOP)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
