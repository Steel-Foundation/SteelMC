//! Vanilla WanderingTrader entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the wandering trader.
...
impl Entity for WanderingTraderEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_WANDERING_TRADER_DISAPPEARED,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for WanderingTraderEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WANDERING_TRADER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WANDERING_TRADER_DEATH)
    }
...
impl Mob for WanderingTraderEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WANDERING_TRADER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
