//! Vanilla Horse entity — ported from Pumpkin (foundation-first).
...
impl LivingEntity for HorseEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HORSE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HORSE_DEATH)
    }
...
impl Mob for HorseEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HORSE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
