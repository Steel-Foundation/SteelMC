//! Vanilla Dolphin entity — ported from Pumpkin (foundation-first).
...
impl Entity for DolphinEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_DOLPHIN_SPLASH,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for DolphinEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_DOLPHIN_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_DOLPHIN_DEATH)
    }
...
impl Mob for DolphinEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_DOLPHIN_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
