//! Vanilla SnowGolem entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the snow golem.
...
impl Entity for SnowGolemEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_SNOW_GOLEM_AMBIENT,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for SnowGolemEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SNOW_GOLEM_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SNOW_GOLEM_DEATH)
    }
...
impl Mob for SnowGolemEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SNOW_GOLEM_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
