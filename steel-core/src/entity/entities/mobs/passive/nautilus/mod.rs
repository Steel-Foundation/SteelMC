//! Vanilla Nautilus entity — ported from Pumpkin (foundation-first).
...
impl Entity for NautilusEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_NAUTILUS_DASH,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for NautilusEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_NAUTILUS_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_NAUTILUS_DEATH)
    }
...
impl Mob for NautilusEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_NAUTILUS_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
