//! Vanilla Fox entity — red/snow variant, sleeping, pouncing.
...
impl FoxEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        living_base.initialize_synced_data(&mut entity_data);
        {
            ...
            gs.add_goal(1, PanicGoal::new(1.4));
            gs.add_goal(2, BreedGoal::new(1.0));
            gs.add_goal(4, FollowParentGoal::new(1.1));
            gs.add_goal(5, WaterAvoidingRandomStrollGoal::new(1.0));
            gs.add_goal(6, LookAtPlayerGoal::new(6.0));
            gs.add_goal(7, RandomLookAroundGoal::new());
        }
        Self {
            base,
            entity_type,
...
impl Entity for FoxEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_FOX_AMBIENT, 0.15, 1.0);
    }
...
impl LivingEntity for FoxEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_FOX_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_FOX_DEATH)
    }
...
impl Mob for FoxEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_FOX_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
