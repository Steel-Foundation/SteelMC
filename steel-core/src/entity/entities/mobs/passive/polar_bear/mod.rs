//! Vanilla PolarBear entity — ported from Pumpkin (foundation-first).
...
impl Entity for PolarBearEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_POLAR_BEAR_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for PolarBearEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_POLAR_BEAR_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_POLAR_BEAR_DEATH)
    }
...
impl Mob for PolarBearEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_POLAR_BEAR_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
