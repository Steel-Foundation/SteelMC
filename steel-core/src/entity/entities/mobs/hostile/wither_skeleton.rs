//! Vanilla WitherSkeleton entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the wither skeleton.
...
impl Entity for WitherSkeletonEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_WITHER_SKELETON_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for WitherSkeletonEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WITHER_SKELETON_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WITHER_SKELETON_DEATH)
    }
...
impl Mob for WitherSkeletonEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_WITHER_SKELETON_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
