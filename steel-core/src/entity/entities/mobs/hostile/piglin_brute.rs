//! Vanilla PiglinBrute entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the piglin brute.
...
impl Entity for PiglinBruteEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_PIGLIN_BRUTE_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for PiglinBruteEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PIGLIN_BRUTE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PIGLIN_BRUTE_DEATH)
    }
...
impl Mob for PiglinBruteEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PIGLIN_BRUTE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
