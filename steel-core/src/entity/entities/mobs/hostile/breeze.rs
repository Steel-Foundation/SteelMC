//! Vanilla Breeze entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the breeze.
...
impl Entity for BreezeEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_BREEZE_SLIDE,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for BreezeEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BREEZE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BREEZE_DEATH)
    }
...
impl Mob for BreezeEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BREEZE_IDLE_GROUND)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
