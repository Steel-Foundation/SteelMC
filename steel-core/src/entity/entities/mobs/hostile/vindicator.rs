//! Vanilla Vindicator entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the vindicator.
...
impl LivingEntity for VindicatorEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_VINDICATOR_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_VINDICATOR_DEATH)
    }
...
impl Mob for VindicatorEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_VINDICATOR_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
