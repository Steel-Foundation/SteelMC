//! Vanilla Vex entity — ported from Pumpkin (foundation-first).
...
impl Entity for VexEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_VEX_CHARGE, 0.15, 1.0);
    }
...
impl LivingEntity for VexEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_VEX_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_VEX_DEATH)
    }
...
impl Mob for VexEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_VEX_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
