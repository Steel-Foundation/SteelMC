//! Vanilla Slime entity — ported from Pumpkin (foundation-first).
...
impl Entity for SlimeEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_SLIME_JUMP, 0.15, 1.0);
    }
...
impl LivingEntity for SlimeEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SLIME_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SLIME_DEATH)
    }
...
impl Mob for SlimeEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SLIME_SQUISH)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
