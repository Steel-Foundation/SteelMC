//! Vanilla Zoglin entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the zoglin.
...
impl Entity for ZoglinEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_ZOGLIN_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for ZoglinEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOGLIN_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOGLIN_DEATH)
    }
...
impl Mob for ZoglinEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOGLIN_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
