//! Vanilla Bogged entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the bogged.
...
impl Entity for BoggedEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_BOGGED_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for BoggedEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BOGGED_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BOGGED_DEATH)
    }
...
impl Mob for BoggedEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BOGGED_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
