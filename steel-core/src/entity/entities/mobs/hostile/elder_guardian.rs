//! Vanilla ElderGuardian entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the elder guardian.
...
impl Entity for ElderGuardianEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_ELDER_GUARDIAN_FLOP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for ElderGuardianEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ELDER_GUARDIAN_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ELDER_GUARDIAN_DEATH)
    }
...
impl Mob for ElderGuardianEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ELDER_GUARDIAN_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
