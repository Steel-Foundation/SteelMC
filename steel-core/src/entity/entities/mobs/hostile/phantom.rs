//! Vanilla Phantom entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the phantom.
...
impl Entity for PhantomEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_PHANTOM_FLAP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for PhantomEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PHANTOM_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PHANTOM_DEATH)
    }
...
impl Mob for PhantomEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PHANTOM_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
