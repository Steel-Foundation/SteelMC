//! Vanilla Pillager entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the pillager.
...
impl LivingEntity for PillagerEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PILLAGER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PILLAGER_DEATH)
    }
...
impl Mob for PillagerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PILLAGER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
