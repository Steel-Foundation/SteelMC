...
impl EndermanEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
...

        {
            ...
            // TODO: Add enderman-specific goals (teleport, pick up blocks, place blocks)
        }

        {
            ...
            // TODO: Add endermite targeting goal
        }
...
impl LivingEntity for EndermanEntity {
    ...
    fn ai_step(&self) -> Option<MoveResult> {
        ...
        // TODO: Implement enderman-specific logic:
        // - Teleport away from water/projectiles
        // - Take damage in water/rain
        result
    }
}
...
impl Mob for EndermanEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        // TODO: Check if angry and return SCREAM instead
