//! Vanilla Silverfish entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the silverfish.
...
impl Entity for SilverfishEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_SILVERFISH_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for SilverfishEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SILVERFISH_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SILVERFISH_DEATH)
    }
...
impl Mob for SilverfishEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SILVERFISH_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
