//! Vanilla Creaking entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the creaking.
...
impl Entity for CreakingEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_CREAKING_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for CreakingEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_CREAKING_FREEZE)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_CREAKING_DEATH)
    }
...
impl Mob for CreakingEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_CREAKING_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
