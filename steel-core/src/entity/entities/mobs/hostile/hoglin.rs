//! Vanilla Hoglin entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the hoglin.
...
impl Entity for HoglinEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_HOGLIN_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for HoglinEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HOGLIN_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HOGLIN_DEATH)
    }
...
impl Mob for HoglinEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_HOGLIN_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
