//! Vanilla ZombifiedPiglin entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the zombified piglin.
...
impl Entity for ZombifiedPiglinEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_PIGLIN_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for ZombifiedPiglinEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIFIED_PIGLIN_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIFIED_PIGLIN_DEATH)
    }
...
impl Mob for ZombifiedPiglinEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIFIED_PIGLIN_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
