//! Vanilla Evoker entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the evoker.
...
impl Entity for EvokerEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_EVOKER_PREPARE_ATTACK,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for EvokerEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_EVOKER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_EVOKER_DEATH)
    }
...
impl Mob for EvokerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_EVOKER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
