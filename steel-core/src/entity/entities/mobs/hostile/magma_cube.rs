//! Vanilla MagmaCube entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the magma cube.
...
impl Entity for MagmaCubeEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_MAGMA_CUBE_JUMP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for MagmaCubeEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_MAGMA_CUBE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_MAGMA_CUBE_DEATH)
    }
...
impl Mob for MagmaCubeEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_MAGMA_CUBE_SQUISH)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
