//! Vanilla Bat entity — ported from Pumpkin (foundation-first).
...
impl Entity for BatEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_BAT_TAKEOFF, 0.15, 1.0);
    }
...
impl LivingEntity for BatEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BAT_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BAT_DEATH)
    }
...
impl Mob for BatEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BAT_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
