//! Vanilla Ravager entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the ravager.
...
impl Entity for RavagerEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_RAVAGER_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for RavagerEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_RAVAGER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_RAVAGER_DEATH)
    }
...
impl Mob for RavagerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_RAVAGER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
