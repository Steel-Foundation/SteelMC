//! Vanilla Blaze entity — ported from Pumpkin (foundation-first).
...
impl Entity for BlazeEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_BLAZE_AMBIENT,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for BlazeEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BLAZE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BLAZE_DEATH)
    }
...
impl Mob for BlazeEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_BLAZE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
