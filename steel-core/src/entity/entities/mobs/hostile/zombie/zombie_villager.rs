//! Zombie Villager entity implementation.
...
/// Zombie Villager — curable back to villager with weakness potion + golden apple.
...
impl ZombieVillagerEntity {
    ...
    fn new_with_base(base: EntityBase, entity_type: EntityTypeRef) -> Self {
        ...
        let mut random = Xoroshiro::from_seed(base.id() as u64);
...
impl Entity for ZombieVillagerEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block_state: BlockStateId) {
        self.play_sound(&sound_events::ENTITY_ZOMBIE_VILLAGER_STEP, 0.15, 1.0);
    }
...
mod tests {
    ...
    #[test]
    fn zombie_villager_creates_with_correct_entity_type() {
        init_vanilla_registry();
        let zv = ZombieVillagerEntity::new(
            &vanilla_entities::ZOMBIE_VILLAGER,
            1,
            DVec3::ZERO,
            Weak::new(),
        );
        assert_eq!(zv.entity_type(), &vanilla_entities::ZOMBIE_VILLAGER);
    }

    #[test]
    fn zombie_villager_starts_as_non_baby() {
        init_vanilla_registry();
        let zv = ZombieVillagerEntity::new(
            &vanilla_entities::ZOMBIE_VILLAGER,
            1,
