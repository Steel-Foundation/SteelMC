...
/// Husk zombie variant — desert-spawning, immune to sun burning.
...
impl Entity for HuskEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block_state: BlockStateId) {
        self.play_sound(&sound_events::ENTITY_HUSK_STEP, 0.15, 1.0);
    }
...
mod tests {
    ...
    #[test]
    fn husk_creates_with_correct_entity_type() {
        init_vanilla_registry();
        let husk = HuskEntity::new(&vanilla_entities::HUSK, 1, DVec3::ZERO, Weak::new());
        assert_eq!(husk.entity_type(), &vanilla_entities::HUSK);
    }

    #[test]
    fn husk_starts_as_non_baby() {
        init_vanilla_registry();
        let husk = HuskEntity::new(&vanilla_entities::HUSK, 1, DVec3::ZERO, Weak::new());
        assert!(!husk.is_baby());
    }
