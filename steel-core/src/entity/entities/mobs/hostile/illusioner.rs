//! Vanilla Illusioner entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the illusioner.
...
impl Entity for IllusionerEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_ILLUSIONER_CAST_SPELL,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for IllusionerEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ILLUSIONER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ILLUSIONER_DEATH)
    }
...
impl Mob for IllusionerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ILLUSIONER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
