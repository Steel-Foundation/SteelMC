//! Vanilla Giant entity — ported from Pumpkin (foundation-first).
...
impl Entity for GiantEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_ZOMBIE_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for GiantEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIE_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIE_DEATH)
    }
...
impl Mob for GiantEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_ZOMBIE_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
