//! Vanilla Parched entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the parched.
...
impl Entity for ParchedEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_PARCHED_STEP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for ParchedEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PARCHED_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PARCHED_DEATH)
    }
...
impl Mob for ParchedEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_PARCHED_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
