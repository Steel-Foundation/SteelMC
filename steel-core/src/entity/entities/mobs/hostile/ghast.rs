//! Vanilla Ghast entity — ported from Pumpkin (foundation-first).
...
impl Entity for GhastEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_GHAST_SHOOT, 0.15, 1.0);
    }
...
impl LivingEntity for GhastEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GHAST_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GHAST_DEATH)
    }
...
impl Mob for GhastEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GHAST_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
