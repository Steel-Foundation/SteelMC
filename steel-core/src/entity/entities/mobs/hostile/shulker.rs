//! Vanilla Shulker entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the shulker.
...
impl Entity for ShulkerEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_SHULKER_CLOSE,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for ShulkerEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SHULKER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SHULKER_DEATH)
    }
...
impl Mob for ShulkerEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SHULKER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
