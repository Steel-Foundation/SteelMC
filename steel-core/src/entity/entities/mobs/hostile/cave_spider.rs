//! Vanilla CaveSpider entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the cave spider.
...
impl Entity for CaveSpiderEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(&steel_registry::sound_events::ENTITY_SPIDER_STEP, 0.15, 1.0);
    }
...
impl LivingEntity for CaveSpiderEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SPIDER_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SPIDER_DEATH)
    }
...
impl Mob for CaveSpiderEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_SPIDER_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
