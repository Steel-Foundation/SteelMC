//! Vanilla Guardian entity — ported from Pumpkin (foundation-first).
...
/// Entity behavior for the guardian.
...
impl Entity for GuardianEntity {
    ...
    fn play_step_sound(&self, _pos: BlockPos, _block: BlockStateId) {
        self.play_sound(
            &steel_registry::sound_events::ENTITY_GUARDIAN_FLOP,
            0.15,
            1.0,
        );
    }
...
impl LivingEntity for GuardianEntity {
    ...
    fn hurt_sound(&self, _s: &DamageSource) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GUARDIAN_HURT)
    }
    fn death_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GUARDIAN_DEATH)
    }
...
impl Mob for GuardianEntity {
    ...
    fn ambient_sound(&self) -> Option<SoundEventRef> {
        Some(&steel_registry::sound_events::ENTITY_GUARDIAN_AMBIENT)
    }
    fn finalize_spawn(
        &self,
        world: &Arc<World>,
