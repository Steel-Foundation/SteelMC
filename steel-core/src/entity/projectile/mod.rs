...
struct ProjectileState {
    owner: Option<Uuid>,
    owner_entity: Option<WeakEntity>,
    left_owner: bool,
...
pub trait Projectile: Entity {
    ...
    fn is_outside_owner_collision_range(&self) -> bool {
        ...
        while let Some(entity) = to_check.pop() {
            ...
            if entity.with_entity(|candidate| candidate.is_pickable())
    ...
    fn can_hit_entity(&self, entity: &dyn Entity) -> bool {
        ...
        self.left_owner() || owner.root_vehicle_id() != entity.root_vehicle_id()
    }
    ...
    fn projectile_base_tick(&mut self) {
...
fn get_entity_hit_result(
    ...
    for entity in world.get_entities_in_aabb(&search_box) {
        if !entity.with_entity(|candidate| predicate(candidate)) {
            continue;
        }
...
mod tests {
    ...
    fn owner_collision_range_checks_root_vehicle_passengers() {
        ...
        let projectile = OwnerCollisionProjectile::shared(1, DVec3::ZERO);
        ...
        projectile.with_entity(|entity| {
            let projectile = entity
                .downcast_mut::<OwnerCollisionProjectile>()
                .expect("projectile");
