...
pub(super) use steel_registry::feature::{
    ...
    DripstoneClusterConfiguration, DualNoiseProvider, EndGatewayConfiguration,
    FallenTreeConfiguration, FeatureHeightmap, FeatureNoiseParameters, FeatureSize, FluidStateData,
    FoliagePlacer, GeodeBlockSettings, GeodeConfiguration, HugeFungusConfiguration,
    HugeMushroomConfiguration, IdentifierList, LakeConfiguration, LargeDripstoneConfiguration,
