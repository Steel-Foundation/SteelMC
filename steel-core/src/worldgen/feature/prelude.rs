...
pub(super) use steel_registry::feature::{
    ...
    FoliagePlacer, FossilConfiguration, GeodeBlockSettings, GeodeConfiguration,
    HugeFungusConfiguration, HugeMushroomConfiguration, IdentifierList, LakeConfiguration,
