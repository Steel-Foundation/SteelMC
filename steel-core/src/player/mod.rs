...
use crate::entity::{
    DEATH_DURATION, Entity, EntityAnchor, EntityBase, EntityEventSource, EntityId,
    EntityMovementEmission, EntitySyncedData, LivingEntity, LivingEntityBase, MobEffectSyncChange,
...
mod tests {
    ...
    use crate::config::RuntimeConfig;
    use crate::entity::{EntityId, EntitySyncedData, LivingEntity, damage::DamageSource};
    ...
    fn conditional_damage_does_not_scale_for_player_or_unresolved_causes() {
        ...
        let unresolved_source = source.with_causing_entity(EntityId::new(2));
