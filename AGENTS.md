...
The `minecraft-src/` folder should be generated by `./script/update-minecraft-src.sh` in bash or `./script/update-minecraft-src.ps1` in powershell. If it isn't, stop and state the issue to the user.
