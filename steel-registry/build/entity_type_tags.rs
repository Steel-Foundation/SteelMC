...
pub(crate) fn build() -> TokenStream {
    println!(
        "cargo:rerun-if-changed=build_assets/builtin_datapacks/minecraft/data/minecraft/tags/entity_type/"
    );

    let tag_dir = "build_assets/builtin_datapacks/minecraft/data/minecraft/tags/entity_type";
    ...
    stream.extend(quote! {
        use crate::entity_types::EntityTypeRegistry;
    ...
    stream.extend(quote! {
        pub fn register_entity_type_tags(registry: &mut EntityTypeRegistry) {
            #register_stream
        }
    });
