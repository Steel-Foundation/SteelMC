...
use metadata::{
    banner_pattern_ref_token, block_transformer_ref_token, brewing_fuel_component_token,
    compostable_component_token, cooking_fuel_component_token, damage_type_ref_token,
    entity_type_ref_token, holder_set_component_field, holder_set_token, item_name_component_token,
    item_ref_token, mob_visibility_component_token, optional_identifier_token,
    pottery_pattern_component_token, rarity_component_token, registry_sound_event_holder_token,
    sign_text_component_token, sound_event_holder_token, sound_event_value_token,
