...
use metadata::{
    ...
    entity_type_ref_token, mob_visibility_component_token,
    ...
    registry_sound_event_holder_token, sign_text_component_token, sound_event_holder_token,
    sound_event_value_token, swing_animation_component_token, use_effects_component_token,
