...
pub(crate) fn build() -> TokenStream {
    println!(
        "cargo:rerun-if-changed=build_assets/builtin_datapacks/minecraft/data/minecraft/tags/point_of_interest_type/"
    );

    let tag_dir =
        "build_assets/builtin_datapacks/minecraft/data/minecraft/tags/point_of_interest_type";
    ...
    stream.extend(quote! {
        pub fn register_poi_type_tags(registry: &mut PoiTypeRegistry) {
            #register_stream
        }
    });
